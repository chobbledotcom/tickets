...
- `PAYMENT_HISTORY_REDACTION_DAYS` - Days to retain PII-heavy terminal payment evidence before redacting it (default 90, minimum 3). Replay identities, provider resources, exact charge and refund money, attendee links, and decision audit rows remain.
