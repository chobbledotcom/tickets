...
`CDN_BUNNY_STORAGE_ZONE_KEY`, and `CDN_BUNNY_PULL_ZONE_ID` are GitHub repository secrets used
only while building. When all four are set, the build uploads site-independent browser
