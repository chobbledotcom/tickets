...
| Public balance recap       | `src/shared/db/attendees/balance.ts`, `src/features/public/balance.ts`, `src/ui/templates/public/balance.tsx`, shared package-row grouping | `test/shared/db/attendees/balance.test.ts`, `test/integration/server/balance-get.test.ts`, `test/integration/server/balance-post.test.ts`             |
