/** Every migration from the first stored schema through the 2026-07 work, in
 * run order. Part one of the registry (see registry.ts). */
...
export const ENTRIES_THROUGH_JULY: MigrationRegistryEntry[] = [
  entry(
