...
type ValidChain<Fns extends Fn[]> = Fns extends [Fn] ? true
  : Fns extends
...
type ValidAsyncChain<Fns extends AsyncFn[]> = Fns extends [AsyncFn] ? true
  : Fns extends [
...
export const mapParallel =
  <T, U>(fn: (item: T) => Promise<U>) => (array: T[]): Promise<U[]> =>
