  ...
  <fieldset class="agreement">
    ...
    <ol>
      <li>
        ...
        - You decide what data to collect and are responsible for your own
        GDPR/data protection compliance
      </li>
      <li>
        <strong>We are a data processor</strong>{" "}
        - We store your encrypted data but cannot access attendee information
        without your admin password
      </li>
      <li>
        <strong>Your data is encrypted</strong>{" "}
        - Attendee names, emails, and payment references are encrypted at rest.
        Only you can decrypt them by logging in
      </li>
      <li>
        <strong>Your responsibilities</strong>{" "}
        - You are responsible for providing a privacy policy, having lawful
        basis for collecting data, responding to data subject requests, and
        compliance with your local data protection laws
      </li>
      <li>
        <strong>Breach notification</strong>{" "}
        - We will notify you promptly if we detect a security incident affecting
        your data
      </li>
      <li>
        <strong>Deletion</strong>{" "}
        - Your data is deleted when you delete your events or close your account
      </li>
    </ol>
    <p class="password-warning">
      If you lose your password you will be <u>permanently</u>{" "}
      unable to view attendee lists. Do not lose your password.
    </p>
    <div class="field">
      <label>
