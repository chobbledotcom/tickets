...
import { initChildCompat } from "./admin/child-compat.ts";
...
import { initOrderGallery } from "./admin/order-gallery.ts";
import { initPairedControls } from "./admin/paired-controls.ts";
