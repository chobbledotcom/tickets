...
const listingConfirmPageFrom =
  ...
  (listing: ListingWithCount, session: AdminSession, error?: string): string =>
...
export const adminDeactivateListingPage = listingConfirmPageFrom((listing) => ({
...
export const adminReactivateListingPage = listingConfirmPageFrom((listing) => ({
