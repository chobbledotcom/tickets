      ...
      <Q q={t("guide.q.setup_email")}>
        ...
        <ol>
          ...
          <li>
            ...
            address that appears on outgoing emails. If left blank, the business
    ...
    <Section id="email-templates" title={t("guide.sections.email_templates")}>
      ...
      <Q q={t("guide.q.template_variables")}>
        ...
        <p>
          ...
          <code>entry.listing.name</code>, <code>entry.attendee.quantity</code>,{" "}
      ...
      <Q q={t("guide.q.template_filters")}>
        ...
        <ul>
          <li>
            <code>{"{{ amount | currency }}"}</code> &mdash; formats a number as
            currency (e.g. &pound;15.00)
          </li>
          <li>
