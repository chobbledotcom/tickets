...
import {
  ...
  type PaymentReferenceProviderBindingRequest,
...
const rowFor = (sessionId: string): Promise<StoredPaymentRow> =>
...
const loadedReference = async (sessionId: string): Promise<PaymentReference> =>
  loadPaymentReference(
...
const claimCapability = async (sessionId: string): Promise<string> => {
