 ...
 * `fetch`, boots the script, and presses the real button.
 */
...
/** A credential the provider accepted, and the estate it points at. */
export const VALID_KEY = { mode: "test", valid: true };
