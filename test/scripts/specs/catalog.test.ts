...
describe("Cucumber story catalog", () => {
  test("reads every story from the repository catalog", async () => {
    expect((await readSpecCatalog()).stories.map(({ id }) => id)).toEqual([
      ...
      "servicing.asking-buyers-a-question",
      "servicing.describing-what-is-on-offer",
      "servicing.filling-the-site-with-example-data",
      "servicing.hearing-from-a-visitor",
      "servicing.hold-and-cost",
      "servicing.keeping-only-what-is-needed",
      "servicing.letting-another-system-in",
      "servicing.narrowing-a-long-list-down",
      "servicing.setting-a-site-up",
      "servicing.telling-people-the-news",
      "servicing.the-front-pages-of-the-site",
