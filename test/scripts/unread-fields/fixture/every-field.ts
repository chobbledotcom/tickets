...
export const EVERY_FIELD: readonly string[] = [
  ...
  "WritesAListTwoWays.withBrackets",
  'WritesAListTwoWays.withBrackets["[]"].insideBrackets',
  "WritesAListTwoWays.withReadonly",
  'WritesAListTwoWays.withReadonly["[]"].insideReadonly',
